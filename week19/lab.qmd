...
::: {.callout-tip}
**Example:** "As predicted, participants in the experimental group showed a significant decline in memory performance (Hypothesis 1). This aligns with findings from Smith and Jones (2020), who reported similar cognitive impairments under acute stress conditions."
:::
...
**Key Points:**
- Address methodological issues (sample size, generalizability)
...
- Results presented accurately with appropriate statistics
...
**In pairs (15 minutes):**
1. Swap seats and look at something your neighbour has written
